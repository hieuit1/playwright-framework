...
- Name: web/seo.spec.ts >> SEO Optimization Feature Tests >> Kiểm Tra chất lượng trang web về seo: Trang Liên hệ (Contact Us Page)
- Location: tests/web/seo.spec.ts:15:9

# Error details

```
Error: Lỗi SEO: Độ dài Title là 32. Phải nằm trong khoảng 50 - 60 ký tự.
...
```
Error: Lỗi SEO NGHIÊM TRỌNG: Trang Liên hệ (Contact Us Page) có 0 thẻ H1. Bắt buộc phải có đúng 1 thẻ H1 duy nhất!
...
- generic [active] [ref=e1]:
  ...
  - generic:
    ...
    - generic:
      - strong: "Trang:"
      - text: Trang Liên hệ (Contact Us Page)
    - generic:
      - generic:
        - strong: 1. Title (50-60 ký tự)
        - generic: ❌
      - generic: Automation Exercise - Contact Us (32 ký tự)
