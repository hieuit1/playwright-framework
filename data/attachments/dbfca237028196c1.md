...
- Name: web/seo.spec.ts >> SEO Optimization Feature Tests >> Kiểm Tra chất lượng trang web về seo: Trang giỏ hàng (Cart Page)
...
```
Error: Lỗi SEO NGHIÊM TRỌNG: Trang giỏ hàng (Cart Page) có 0 thẻ H1. Bắt buộc phải có đúng 1 thẻ H1 duy nhất!
