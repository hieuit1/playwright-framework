...
- Name: web/cart.spec.ts >> Cart Feature Tests - Professional Suite >> [Negative] Prevent guest users from adding products to cart
- Location: tests/web/cart.spec.ts:30:7
